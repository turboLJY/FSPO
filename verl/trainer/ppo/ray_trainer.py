...
class RayPPOTrainer(object):
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            reward_tensor, format_tensor, answer_tensor = self.val_reward_fn(test_batch)
        ...
        for data_source in data_source_answer_reward.keys():
            ...
            reward = data_source_reward[data_source]
            metric_dict[f'val/test_reward_score/{data_source}'] = sum(reward) / len(reward) if len(reward) > 0 else 0
            metric_dict[f'val/test_answer_score/{data_source}'] = sum(answer_reward) / len(answer_reward) if len(answer_reward) > 0 else 0
                ...
                with (_timer('step', timing_raw)):
                    ...
                    with _timer('adv', timing_raw):
                        ...
                        if self.use_rm:
                            ...
                            reward_tensor, format_tensor, answer_tensor = self.reward_fn(batch)
